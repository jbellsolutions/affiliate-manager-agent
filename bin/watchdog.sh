#!/bin/bash
# AI Guy Go To Market watchdog — runs every 60s via crontab.
# new-agent.sh fills in __AGENT_NAME__ / __BASE_DIR__.
#
# DELIBERATE SUPERSET of ai-guy-go-to-market's basic watchdog (kept hardened here because
...
# (If porting an upstream ai-guy-go-to-market watchdog change, preserve this hardening.)
